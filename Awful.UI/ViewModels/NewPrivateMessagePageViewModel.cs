...
namespace Awful.UI.ViewModels
{
    ...
    public class NewPrivateMessagePageViewModel : ThreadPostBaseViewModel
    {
        ...
        public NewPrivateMessagePageViewModel(IAwfulPopup popup, IAwfulNavigation navigation, IAwfulErrorHandler error, TemplateHandler handler, IAwfulContext context)
