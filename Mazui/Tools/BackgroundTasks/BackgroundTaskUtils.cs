...
namespace Mazui.Tools.BackgroundTasks
{
	...
	{
		public const string BackgroundTaskEntryPoint = "Mazui.BackgroundNotify.BackgroundNotifyStatus";
		public const string BackgroundTaskName = "BackgroundNotifyStatus";
		public const string ToastBackgroundTaskEntryPoint = "Mazui.BackgroundNotify.ToastNotificationBackgroundTask";
