...
namespace Awful.Mobile.ViewModels
{
    ...
    public class MobilePrivateMessagesPageViewModel : PrivateMessagesPageViewModel
    {
        ...
        public MobilePrivateMessagesPageViewModel(IAwfulNavigation navigation, IAwfulErrorHandler error, TemplateHandler handler, AwfulContext context) : base(navigation, error, handler, context)
        {
        }
    }
}
