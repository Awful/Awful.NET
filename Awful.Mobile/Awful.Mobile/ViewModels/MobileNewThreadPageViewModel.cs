...
namespace Awful.Mobile.ViewModels
{
    ...
    public class MobileNewThreadPageViewModel : NewThreadPageViewModel
    {
        ...
        public MobileNewThreadPageViewModel(IAwfulPopup popup, IAwfulNavigation navigation, IAwfulErrorHandler error, TemplateHandler handler, IAwfulContext context)
