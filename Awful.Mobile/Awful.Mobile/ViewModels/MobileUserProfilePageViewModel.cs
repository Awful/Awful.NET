...
namespace Awful.Mobile.ViewModels
{
    ...
    public class MobileUserProfilePageViewModel : UserProfilePageViewModel
    {
        ...
        public MobileUserProfilePageViewModel(IAwfulNavigation navigation, IAwfulErrorHandler error, ITemplateHandler handler, IAwfulContext context) : base(navigation, error, handler, context)
        {
        }
    }
}
