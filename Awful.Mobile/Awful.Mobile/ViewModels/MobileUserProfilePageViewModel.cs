...
namespace Awful.Mobile.ViewModels
{
    ...
    public class MobileUserProfilePageViewModel : UserProfilePageViewModel
    {
        ...
        public MobileUserProfilePageViewModel(IAwfulNavigation navigation, IAwfulErrorHandler error, TemplateHandler handler, IAwfulContext context) : base(navigation, error, handler, context)
        {
        }
    }
}
