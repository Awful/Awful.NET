...
namespace Awful.Mobile.ViewModels
{
    ...
    public class MobilePrivateMessagePageViewModel : PrivateMessagePageViewModel
    {
        ...
        public MobilePrivateMessagePageViewModel(IAwfulNavigation navigation, IAwfulErrorHandler error, TemplateHandler handler, IAwfulContext context) : base(navigation, error, handler, context)
        {
        }
    }
}
