...
namespace Mazui.Migrations.Forums
{
    ...
    partial class ForumsContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Mazui.Core.Models.Posts.Post", b =>
                {
            ...
            modelBuilder.Entity("Mazui.Core.Models.Threads.Thread", b =>
                {
                    b.Property<int>("ThreadId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Mazui.Core.Models.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Mazui.Core.Models.Posts.Post", b =>
                {
                    b.HasOne("Mazui.Core.Models.Threads.Thread")
                        .WithMany("Posts")
                        .HasForeignKey("ThreadId");

                    b.HasOne("Mazui.Core.Models.Users.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Mazui.Core.Models.Threads.Thread", b =>
                {
                    b.HasOne("Mazui.Core.Models.Forums.Forum", "ForumEntity")
                        .WithMany()
