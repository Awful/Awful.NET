! function () {
    Function && Function.prototype && Function.prototype.bind && (/MSIE [678]/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || ! function (t) {
        ...
        return e.e = function (t, e) { }, e.e = function (t, n) {
            ...
            if (void 0 !== i[t]) i[t].push(n);
                ...
                o.type = "text/javascript", o.charset = "utf-8", o.async = !0, o.onerror = function () {
                    ...
                    1: "df35e8ba9f4327d5c5f3d4e2afb8b29c",
                    2: "415474f2e22cee7df272249c34e8f0b1",
                    3: "ee08e64b9fadc093a86574aaea2a7aea",
                    4: "3d3e3f87cf2fb3e00e1f2905426dcc55",
                    5: "4d1a742474985923f16ac4776f48c40f",
                    6: "cc13fca8de1be431acaea7ada1c14a7e",
                    7: "be71edefebfd0906c226bc4a3822c95a"
        ...
        var r, i = n(1),
            ...
            m = n(239),
            v = "_e";
        n(273), u.set("widgets.init", !0), a.set("init", !0), p(), r = new i, s.exposeReadyPromise(r.promise, a.base, v), a.set("widgets", l), a.set("widgets.load", f.load), a.set("events", d), h(function () {
            r.resolve(a.base), c.attachTo(o), m.emitter.trigger(m.START), f.loadPage()
        })
    }, function (t, e, n) {
        function r() {
            var t = this;
        ...
        t.exports = function (t, e, n) {
            ...
            return t.id && (o.id = t.id, delete t.id),
                o.allowtransparency = "true", o.scrolling = "no", o.setAttribute("frameBorder", 0), o.setAttribute("allowTransparency", !0), i.forIn(t, function (t, e) {
                    o.setAttribute(t, e)
        ...
        t.exports = {
            version: "3f6f7f68:1515531303446"
        }
    }, function (t, e, n) {
        var r = n(53),
            i = n(62);
        ...
        function r() {
            var t, e, n, r;
            return a = new c, m.ie9() || m.ie10() || "http:" !== l.protocol && "https:" !== l.protocol ? void a.reject(new Error("Unsupported")) : (t = {
                origin: l.origin
            }, e = h.url(v.resourceBaseUrl + v.widgetIframeHtmlPath, t), n = function (t) {
                var n;
                if (e.substr(0, t.origin.length) === t.origin) try {
                    n = f.parse(t.data), n.namespace === g.settings && (a.resolve(), i(n.settings))
                } catch (t) { }
            }, p.addEventListener("message", n), r = u({
                src: e
            }, {
                    display: "none"
        ...
        function i(t) {
            var e = t || {};
            s = new w(e.is_bucketed, e.should_obtain_cookie_consent, e.experiments)
        }
        ...
        t.exports = {
            tweetButtonHtmlPath: "/widgets/tweet_button.c813a76e37891912913dfa688526534e.{{lang}}.html",
            followButtonHtmlPath: "/widgets/follow_button.c813a76e37891912913dfa688526534e.{{lang}}.html",
            hubHtmlPath: "/widgets/hub.html",
            widgetIframeHtmlPath: "/widgets/widget_iframe.c813a76e37891912913dfa688526534e.html",
        ...
        t.exports = {
            css: "2244cdc1aa6afd59d64cc31948a29dca"
        }
    }, , function (t, e, n) {
        function r(t) {
