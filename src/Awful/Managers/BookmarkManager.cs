...
namespace Awful.Managers
{
    ...
    public class BookmarkManager
    {
        ...
        public async Task<ThreadList> GetBookmarkListAsync(int page, int perPage = 40, CancellationToken token = default)
        {
            ...
            {
                throw new Exceptions.AwfulParserException("Failed to find document while getting bookmark thread list page.", new Awful.Entities.SAItem(result));
            }
