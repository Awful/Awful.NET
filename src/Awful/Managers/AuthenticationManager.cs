    ...
    public class AuthenticationManager
    {
        ...
        public async Task<AuthResult> AuthenticateAsync(string username, string password, CancellationToken token = default)
        {
            ...
            try
            {
                ...
                {
                    throw new Awful.Exceptions.AwfulParserException("Could not find AbsoluteEndpoint for auth request", new Awful.Entities.SAItem(webResult));
                }
            ...
            {
                throw new Awful.Exceptions.AwfulParserException(ex, new Awful.Entities.SAItem(webResult));
            }
        }
        ...
        private async Task<AuthResult> FetchUserAsync(CancellationToken token)
        {
            ...
            try
            {
                ...
                if (user == null)
                {
                    throw new Awful.Exceptions.AwfulParserException("FetchUserAsync Failed Parse", new Awful.Entities.SAItem(result));
                }
